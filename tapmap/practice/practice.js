...
import { ROUNDS, todayKey, gameNumber, dateForNumber, totalScore, formatNumber } from "/tapmap/game.js?v=8";

import { mountAccountButton } from "/tapmap/account-button.js?v=3";
